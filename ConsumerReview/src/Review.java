...
public class Review {
  ...
  private static double totalSentimentValue=0.0;
  ...
  public static double totalSentiment(String fileName) {
	  ...
	  try {
	      ...
	      while(input.hasNextLine()){
	        ...
	        String[] words = file.split(SPACE);
	        
	        for (int i=0;i<words.length;i++) {
	        	totalSentimentValue += sentimentVal(removePunctuation(words[i]));
	        }
  ...
  public static int starRating(String fileName) {
	  ...
	  if (totalSentimentValue <= 0.9) {
		  starValue = 1;
	  }
	  else if (totalSentimentValue >= 1.9) {
		  starValue = 2;
	  }
	  else if (totalSentimentValue >= 2.9) {
		  starValue = 3;
	  }
	  else if (totalSentimentValue >= 3.9) {
		  starValue = 4;
	  }
	  else if (totalSentimentValue>= 4.9) {
		  starValue = 5;
	  }
	  else {
		  starValue = 0;
